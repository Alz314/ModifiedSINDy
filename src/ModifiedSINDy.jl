...
export solve_SINDy, ensemble_solve_SINDy, sparsify, CalDerivative, get_trajectory, calc_AIC, calc_RMSE # functions
export SG_smoothing, SG_smoothing_optim, smooth_with_kernel, DCT_smooth # smoothing functions
